namespace Jeninnet.FileQuery.Tests.Infrastructure;
...
internal static class TestPath {
    ...
    public static PathMatchContext Directory(string path)
        => new(path, pathKind: PathKind.Directory, caseSensitivity: CaseSensitivity.Sensitive);
}
