...
public sealed class CharacterClassParserTests {
    ...
    public void Should_MatchCorrectly_When_LiteralSetEndToEnd() {
        ...
        results.Should().Contain(p => p.EndsWith("a.txt", StringComparison.Ordinal));
        results.Should().Contain(p => p.EndsWith("b.txt", StringComparison.Ordinal));
        results.Should().Contain(p => p.EndsWith("c.txt", StringComparison.Ordinal));
        results.Should().NotContain(p => p.EndsWith("d.txt", StringComparison.Ordinal));
    }
    ...
    public void Should_MatchCorrectly_When_CharacterRangeEndToEnd() {
        ...
        Assert.HasCount(3, results);
        results.Should().NotContain(p => p.EndsWith("fileX.txt", StringComparison.Ordinal));
    }
    ...
    public void Should_MatchCorrectly_When_NegatedClassEndToEnd() {
        ...
        results.Should().Contain(p => p.EndsWith("d.txt", StringComparison.Ordinal));
        results.Should().Contain(p => p.EndsWith("e.txt", StringComparison.Ordinal));
    }
    ...
    public void Should_MatchCorrectly_When_PosixDigitClassEndToEnd() {
        ...
        Assert.HasCount(2, results);
        results.Should().Contain(p => p.EndsWith("file1.txt", StringComparison.Ordinal));
        results.Should().Contain(p => p.EndsWith("file2.txt", StringComparison.Ordinal));
        results.Should().NotContain(p => p.EndsWith("fileA.txt", StringComparison.Ordinal));
    }
