...
public class EnumerateFilesAsync_NegationAndPrecedenceTests {
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_ReIncludeFiles_When_NegationApplied_Async() {
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_ApplyLastRule_When_NegationOrderApplied_Async() {
        using var env = new TestEnvironment();
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_BehaveCorrectly_When_ComplexNegationOrdering_Async() {
        using var env = new TestEnvironment();
