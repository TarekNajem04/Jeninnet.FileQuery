...
public class FileQueryEngineAsyncTests {
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_RespectMaxDepth_Async() {
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_ReturnMatchingFiles_Async() {
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_BeCancellable_Async() {
        // ARRANGE: Setup isolated environment
        using var env = new TestEnvironment();
        env.CreateFiles(
            "file1.txt",
    ...
    /// </summary>
    [TestMethod]
    public async Task Should_HandleComplexPatterns_Async() {
        // ARRANGE: Setup isolated environment
        using var env = new TestEnvironment();
        env.CreateFiles(
            "file1.txt",
