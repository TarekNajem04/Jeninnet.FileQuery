...
public sealed class PatternCanonicalizerTests {
    ...
    /// </summary>
    [TestMethod]
    public void Canonicalize_NullInput_ThrowsArgumentNullException() => TestAssertEx.Throws<ArgumentNullException>(static () => PatternCanonicalizer.Canonicalize(null!));
