...
internal static class MatchResultExtensions {
    ...
    public static bool IsSuccess(this MatchResult result)
        => result.IsMatched && result.IsIncluded;
    ...
    public static bool IsExcluded(this MatchResult result)
        => result.IsMatched && !result.IsIncluded;
    ...
    public static bool IsUnmatched(this MatchResult result)
        => !result.IsMatched;
    ...
    public static string ToDebugString(this MatchResult result)
        => $"Matched: {result.IsMatched}, Included: {result.IsIncluded}";
}
